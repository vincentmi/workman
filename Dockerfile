...
COPY php.tar.xz php.tar.xz.asc  /usr/src/
RUN set -xe; \
	\
...
COPY docker-php-ext-* docker-php-entrypoint composer /usr/local/bin/

# sodium was built as a shared module (so that it can be replaced later if so desired), so let's enable it too (https://github.com/docker-library/php/issues/598)
RUN docker-php-ext-install mbstring pdo pdo_mysql bcmath  
RUN docker-php-ext-enable sodium  mbstring pdo_mysql bcmath  
